namespace App3.Class
{
    ...
    public class AutoCompleteTextbox : TextBox
    {
            ...
            : base()
        {
            ...
            this.AutoCompleteList = new List<ComboboxItem>();
            ...
            this.CurrentAutoCompleteList = new List<ComboboxItem>();
        ...
        // the list for our suggestions database
        public List<ComboboxItem> AutoCompleteList = new List<ComboboxItem>();
        /*{
            get;
            set;
        }*/
        ...
        public ComboboxItem SelectedItem
        {
            get
            {
                return (ComboboxItem)listBox.SelectedItem;
            }
        }
        ...
        public String SelectedText
        {
            get
            {
                return ((ComboboxItem)listBox.SelectedItem).Text;
            }
        }

        // the actual list of currently displayed suggestions
        private List<ComboboxItem> CurrentAutoCompleteList
        {
            set;
            get;
        }
        ...
        private void UpdateCurrentAutoCompleteList()
        {
            ...
            foreach (ComboboxItem Str in AutoCompleteList)
            {
                // be casesensitive
                if (CaseSensitive)
                {
                    // search for the substring (equal to SQL Like Command)
                    if ((Str.Text.IndexOf(this.Text) > -1))
                ...
                else
                {
                    ...
                    if ((Str.Text.ToLower().IndexOf(this.Text.ToLower()) > -1))
                    // Add candidates to new CurrentAutoCompleteList
                    { CurrentAutoCompleteList.Add(Str); }
                }
            }
        ...
        public void SetLocationListBoxItem(Point pntSet)
        {
            savePoint = pntSet;
        }

        public void ChangeLocationListBoxItem(Point pntAdd)
        {
            panel.Location = this.Location + new Size(pntAdd.X, pntAdd.Y);
        }
